...
echo Welcome to the tiny11 image creator customized for Image Matters ISO...
...
echo.
md c:\scratchdir
dism /mount-image /imagefile:D:\tiny11\sources\install.wim /index:%index% /mountdir:c:\scratchdir
...
dism /unmount-image /mountdir:c:\scratchdir /commit 
#cls
echo the tiny11 image is now completed. Proceeding with the making of the custom Image Matters ISO...
